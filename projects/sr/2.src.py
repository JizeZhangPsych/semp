...
skip_error = False
sys.path.append("/ohba/pi/mwoolrich/jzhang/semp")
...
if __name__ == "__main__":
    ...
    pf = Pathfinder(prep="after_prep_sts_filt125_trica_bcgica_aasonly_ekg_nonfit", recon="after_src_sts_filt125_trica_bcgica_aasonly_ekg_nonfit")
    pth = pf.get_fdr_dict()
    ...
    if continue_interrupt:
        ...
        for subject, preproc, smri in zip(full_subject_list, full_preproc_file_list, full_smri_file_list):
            ...
            elif skip_error and subject in error_list:
